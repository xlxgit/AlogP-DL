...
model_id = "drugbank_all_joined_logP_SVR_rbf_noopt"
...
nlayer=1
for i in range(1):
    estimators = svm.SVR(kernel='rbf',C=10, gamma=0.1 )
    ...
    fobj.write('training score: ' + str(history.score(X_train, Y_train,)) + '\n')
