...
model_id = "drugbank_all_joined_XGB_noopt"
...
nlayer=1
for i in range(1):
    estimators=xgb.XGBRegressor(n_estimators=700, max_depth=6, min_child_weight=6,gamma=0.3,
            colsample_bytree=0.6, subsample=0.6, reg_alpha=0.05, reg_lambda= 5,learning_rate=0.05,
            base_score=0.3, colsample_bylevel=1,)
