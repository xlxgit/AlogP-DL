...
model_id = "drugbank_all_joined_XGB_opt"
...
nlayer=1
for i in range(1):
    estimators=xgb.XGBRegressor(n_estimators=400, max_depth=8, min_child_weight=5,gamma=0.1,
            colsample_bytree=0.7, subsample=0.7, 
            reg_alpha=0.1, reg_lambda= 0.05, learning_rate=0.05,
