...
from keras.layers import Input, Dense, concatenate, Dropout, Flatten, LSTM
...
model_id="Regression-learning-all-joined-lstm"
...
def build_model():
    ...
    inputs2 = Input(shape=(1, 167 ))
    model1_1 = LSTM(2048, input_dim=2048,return_sequences=True,input_shape=(n_timesteps,data_dim) )(inputs1)
    model1_2 = LSTM(10,  )(model1_1)
    model2_1 = LSTM(200, input_dim=167,return_sequences=True,input_shape=(n_timesteps,data_dim) )(inputs2)
    model2_2 = LSTM(100,  )(model2_1)
    model1_3 = Dropout(0.1)(model1_2)
    model2_3 = Dropout(0.1)(model2_2)
