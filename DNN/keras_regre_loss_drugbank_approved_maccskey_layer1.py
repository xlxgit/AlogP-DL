...
# load dataset
model_id = "drugbank_approved_logP_maccskeys_layer1_"
...
def wider_model():
    ...
    model.add(Dense(300, kernel_initializer='normal', activation='relu',kernel_regularizer=l2(0.0003), W_constraint=maxnorm(4)))
...
loss0 = model.evaluate(X_train, Y_train)
print("train loss: {}".format(loss0))
