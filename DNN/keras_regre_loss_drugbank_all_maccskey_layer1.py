...
# load dataset
model_id = "drugbank_all_logP_maccskeys_layer1_"
...
def wider_model():
    # create model
    model = Sequential()
    model.add(Dense(200, input_dim=167, kernel_initializer='normal', activation='relu', kernel_regularizer=l2(0.0003), W_constraint=maxnorm(4)))
    model.add(Dense(100, kernel_initializer='normal', activation='relu',kernel_regularizer=l2(0.0003), W_constraint=maxnorm(4)))
