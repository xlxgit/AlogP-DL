...
# load dataset
model_id = "drugbank_approved_logP_joined_linear_noopt"
...
def wider_model():
    # create model
    model = Sequential()
    model.add(Dense(200, input_dim=2215, kernel_initializer='normal', activation='relu',kernel_regularizer=l2(0.0003), W_constraint=maxnorm(1)))
