...
model_id="Regression-learning-all-joined"
...
def build_model():
    ...
    model1_2 = Dense(10, kernel_initializer='normal', activation='relu',kernel_regularizer=l2(0.0003), W_constraint=maxnorm(4))(model1_1)
    ...
    model2_2 = Dense(100, kernel_initializer='normal', activation='relu',kernel_regularizer=l2(0.0003), W_constraint=maxnorm(4))(model2_1)
