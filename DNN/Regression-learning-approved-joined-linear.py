...
def build_model():
    ...
    model1_4 = Dense(1, activation='linear')(model1_3)
    model2_4 = Dense(1, activation='linear')(model2_3)
    #con = concatenate([model1_4, model2_4])
    #output = Dense(1, activation='linear')(con1)
    output1 = Dense(1, activation='linear')(model1_4)
    output2 = Dense(1, activation='linear')(model2_4)
...
if __name__ == '__main__':
	...
	#model.fit([x1_train, x2_train], [y1_train, y2_train])
        ...
        print("train_pearson: ",scipy.stats.pearsonr(y1_train,predicted0[0]))
        print("train_pearson: ",scipy.stats.pearsonr(y1_train,predicted0[1]))
        print("train_pearson: ",scipy.stats.pearsonr(y1_train,avg0))
        ...
        print("test_pearson: ",scipy.stats.pearsonr(y1_test,predicted1[0]))
        print("test_pearson: ",scipy.stats.pearsonr(y1_test,predicted1[1]))
        print("test_pearson: ",scipy.stats.pearsonr(y1_test,avg1))
