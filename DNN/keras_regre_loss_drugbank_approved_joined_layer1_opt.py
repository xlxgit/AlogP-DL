...
# load dataset
model_id = "drugbank_approved_logP_joined_layer1_opt"
...
def wider_model():
    ...
    model.add(Dense(50, kernel_initializer='normal', activation='relu',kernel_regularizer=l2(0.0003), W_constraint=maxnorm(1)))
