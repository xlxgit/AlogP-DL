...
model_id = "drugbank_all_logP_RF_maccs_opt"
...
# define wider model
model = RandomForestRegressor(n_estimators=50, max_depth=18, min_samples_split=6, min_samples_leaf=5, max_features='sqrt', oob_score=True,)
...
nlayer=1
for i in range(20):
    estimators = RandomForestRegressor(n_estimators=50, max_depth=18, min_samples_split=6, min_samples_leaf=5, 
